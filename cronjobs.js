...
import { removeOldEntries } from "./commands/transfers/transferList.js"
...
export const initCronJobs = ({dbClient, allActiveTeams, allNationalSelections, allLeagues}) => {
  const cronJobs = [
    ...
    [
      '0 3 * * *',
      async function() {
        console.log('Cleaning up old transfer list and LFT entries')
        await removeOldEntries(dbClient)
      }
    ]
  ]
